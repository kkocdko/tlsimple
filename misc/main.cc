...
// const pem=`---- PRIVATE...`;fetch("data:;base64,"+pem.split("-----")[2].replaceAll("\n","")).then(v=>v.arrayBuffer()).then(v=>console.log([...new Uint8Array(v)].map(v=>"\\x"+v.toString(16).padStart(2,"0")).join("")))
// clang-format on
